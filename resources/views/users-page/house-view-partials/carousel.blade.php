            ...
            <div id="carousel" class="relative w-full">
                ...
                <div class="h-56 overflow-hidden mt-4 md:h-96 dark:bg-black">
                    ...
                    @foreach($house->housePic as $key => $items)
                        <div class="carousel-item inset-0 w-full h-full transition-all duration-700 {{ $loop->first ? 'block' : 'hidden' }}" 
                    ...
                    <div class="inset-0 w-full h-full" >
                        <img src="{{asset('storage/default/house/unavailable.png')}}" class="block h-full mx-auto object-cover">
                    </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="flex flex-col place-content-end">
                        <div class="flex flex-row gap-2">
                            @foreach($house->User->PhoneNumber as $item)
                                ...
                                @endphp
                                @if ($contact)
                                    <a href="{{$contact->url.$item->contact}}" class="size-10">
                        ...
                        <p class="font-black text-xl text-gray-800 dark:text-gray-500 leading-tight text-right">{{$house->views}} Views</p>
                    </div>
                </div>
            </div>
        </div>
