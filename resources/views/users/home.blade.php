...
<section class="section__container plan__container">
    ...
    <h2 class="section__header" data-aos="fade-up" data-aos-delay="200">Plan your Building with confidence</h2>
    ...
    <div class="plan__grid">
        <div class="plan__content" data-aos="fade-right">
            ...
            <p data-aos="fade-right" data-aos-delay="450">
                Get to know the individuals behind our website! <br>Learn about our diverse team members,
                their roles, <br>and their dedication to providing you with the <br> best possible experience.
            </p>
...
<div class="teksatas">
    ...
    <h1 class="h1" data-aos="fade-up" data-aos-delay="100">3 Thing's About our <span>Website</span></h1>
    </div>
    <div class="teksbawah">
    <div class="card" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="card-text">
            <h2>Cari Rumah</h2>
            <p>Fitur ini Berguna bagi pengguna yang sedang Membutuhkan <br> Rumah Impian <br> Cari , Transaksi, Tempati!</p>
        </div>
    </div>
    <div class="card" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="card-text">
            <h2>Konsultasi</h2>
            <p>Selain Mencari Rumah, Kami menyediakan Konsultan yang <br> siap membantu dalam Pembangunan Anda! <br> Konsultasi, Renovasi, Tempati!</p>
        </div>
    </div>
    <div class="card" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="card-text">
            <h2>Easy To Use</h2>
            <p>Website kami berusaha membuat <br>Transaksi Beli, Bangun dan renovasi rumah menjadi lebih mudah Bergabung Dengan Kami!</p>
        </div>
    </div>
   </div>
</div>
                   ...
                   <p>Bersama 4C, kami komitmen untuk menjadi Website terpercaya dalam <br>mewujudkan 
                       ...
                       <div class="col">
                           ...
                           <form>
                               ...
                               <button type="submit"><img class="panah" src="Assets/panahKananPutih.png" width="10px" height="20px"></button>
                           </form>
